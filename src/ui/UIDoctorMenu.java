...
public class UIDoctorMenu {
    ...
    public static ArrayList<Doctor> doctosAvailableAppoinments = new ArrayList<>();
        ...
        do {
            ...
            if(response > 0 && response < 4){
                ...
                do {
                    ...
                    time =sc.nextLine();
                    System.out.println("You date is: " + time + "\n1. Correct \n2. Change Time");
    ...
    private static void checkDoctorAvailableAppointments(Doctor doctor){
        if(doctor.getAvailableAppointments().size() > 0 && !doctosAvailableAppoinments.contains(doctor)){
            doctosAvailableAppoinments.add(doctor);
        }
